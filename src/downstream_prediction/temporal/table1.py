...
def main():
    ...
    window = 'six_months'
    df = pl.scan_parquet(label_path / f'temporal_baseline_features_six_months_test.parquet')
    ...
    for i, outcome in enumerate(outcomes):
        ...
        baseline_table.to_csv(f'temporal_table1_{outcome}.csv')
