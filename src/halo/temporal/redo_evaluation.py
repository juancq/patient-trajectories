...
def main():
    ...
    if config.test_size is not None: 
        ...
        ids = ids.collect(**streaming).sample(n=test_size, seed=config.seed)
    ...
    for task in config.tasks:
        ...
        for window in config.windows:
            ...
            labels = labels.collect(**streaming)
            ...
            window_data = window_data.collect(**streaming)
            ...
            df_baseline_window = df_baseline_window.collect(**streaming)
